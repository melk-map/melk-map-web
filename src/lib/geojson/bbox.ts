 ...
 */
export type _GeoJSONBBoxGeneric<P extends GeoJSONAnyPosition> =
...
export type GeoJSONBBoxGenericSchemaType<P extends GeoJSONAnyPosition> =
	z.ZodType<_GeoJSONBBoxGeneric<P>>;
...
export const GeoJSONBBoxGenericSchema = <P extends GeoJSONAnyPosition>(
	...
	if (positionSchema instanceof z.ZodTuple) {
		...
		return z
			.number()
			.array()
			.length(itemCount * 2) as unknown as z.ZodType<
			GeoJSONBBoxGeneric<P>
		>;
	}
...
export type GeoJSONBBoxGeneric<P extends GeoJSONAnyPosition> = z.infer<
	ReturnType<typeof GeoJSONBBoxGenericSchema<P>>
>;

export const GeoJSON2DBBoxSchema = GeoJSONBBoxGenericSchema(
	GeoJSON2DPositionSchema,
);
export type GeoJSON2DBBox = z.infer<typeof GeoJSON2DBBoxSchema>;

export const GeoJSON3DBBoxSchema = GeoJSONBBoxGenericSchema(
	GeoJSON3DPositionSchema,
);
export type GeoJSON3DBBox = z.infer<typeof GeoJSON3DBBoxSchema>;

export const GeoJSONBBoxSchema = GeoJSONBBoxGenericSchema(
	GeoJSONPositionSchema,
);
