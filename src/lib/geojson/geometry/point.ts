...
export type GeoJSONPointGenericSchemaType<P extends GeoJSONAnyPosition> =
	z.ZodObject<
...
export const GeoJSONPointSchema = GeoJSONPointGenericSchema(
	GeoJSONPositionSchema,
);
export type GeoJSONPoint = z.infer<typeof GeoJSONPointSchema>;

export const GeoJSON2DPointSchema = GeoJSONPointGenericSchema(
	GeoJSON2DPositionSchema,
);
export type GeoJSON2DPoint = z.infer<typeof GeoJSON2DPointSchema>;

export const GeoJSON3DPointSchema = GeoJSONPointGenericSchema(
	GeoJSON3DPositionSchema,
);
