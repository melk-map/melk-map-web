...
import {
	getInvalidPolygonLinearRingIssue,
	validPolygonRings,
} from "./validation/linear_ring";

export type GeoJSONPolygonGenericSchemaType<P extends GeoJSONAnyPosition> =
	z.ZodObject<
...
export const GeoJSONPolygonSchema = GeoJSONPolygonGenericSchema(
	GeoJSONPositionSchema,
);
export type GeoJSONPolygon = z.infer<typeof GeoJSONPolygonSchema>;

export const GeoJSON2DPolygonSchema = GeoJSONPolygonGenericSchema(
	GeoJSON2DPositionSchema,
);
export type GeoJSON2DPolygon = z.infer<typeof GeoJSON2DPolygonSchema>;

export const GeoJSON3DPolygonSchema = GeoJSONPolygonGenericSchema(
	GeoJSON3DPositionSchema,
);
