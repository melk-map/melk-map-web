...
export type GeoJSONLineStringGenericSchemaType<P extends GeoJSONAnyPosition> =
	z.ZodObject<
...
export const GeoJSONLineStringSchema = GeoJSONLineStringGenericSchema(
	GeoJSONPositionSchema,
);
export type GeoJSONLineString = z.infer<typeof GeoJSONLineStringSchema>;

export const GeoJSON2DLineStringSchema = GeoJSONLineStringGenericSchema(
	GeoJSON2DPositionSchema,
);
export type GeoJSON2DLineString = z.infer<typeof GeoJSON2DLineStringSchema>;

export const GeoJSON3DLineStringSchema = GeoJSONLineStringGenericSchema(
	GeoJSON3DPositionSchema,
);
