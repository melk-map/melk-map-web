...
import {
	getInvalidBBoxIssue,
	validBBoxForPositionGridList,
} from "./validation/bbox";
import {
	getInvalidDimensionIssue,
	validDimensionsForPositionGridList,
} from "./validation/dimension";
import {
	getInvalidMultiPolygonLinearRingIssue,
	validMultiPolygonLinearRings,
} from "./validation/linear_ring";

export type GeoJSONMultiPolygonGenericSchemaType<P extends GeoJSONAnyPosition> =
	z.ZodObject<
...
export const GeoJSONMultiPolygonSchema = GeoJSONMultiPolygonGenericSchema(
	GeoJSONPositionSchema,
);
export type GeoJSONMultiPolygon = z.infer<typeof GeoJSONMultiPolygonSchema>;

export const GeoJSON2DMultiPolygonSchema = GeoJSONMultiPolygonGenericSchema(
	GeoJSON2DPositionSchema,
);
export type GeoJSON2DMultiPolygon = z.infer<typeof GeoJSON2DMultiPolygonSchema>;

export const GeoJSON3DMultiPolygonSchema = GeoJSONMultiPolygonGenericSchema(
	GeoJSON3DPositionSchema,
);
