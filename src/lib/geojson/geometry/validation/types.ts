...
export type ValidatableList = {
	type:
		| typeof GeoJSONGeometryType.MultiPoint
		| typeof GeoJSONGeometryType.LineString;
	bbox?: number[] | null;
	coordinates?: number[][] | null;
};
export type ValidatableGrid = {
	type:
		| typeof GeoJSONGeometryType.MultiLineString
		| typeof GeoJSONGeometryType.Polygon;
	bbox?: number[] | null;
	coordinates?: number[][][] | null;
};
